...
describe("job transitions", () => {
  it("allows the Phase 1 progression", () => { expect(canTransitionJob("pending", "en_route")).toBe(true); expect(canTransitionJob("en_route", "arrived")).toBe(true); expect(canTransitionJob("arrived", "complete")).toBe(true); });
