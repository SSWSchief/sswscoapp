    ...
    <main className="app-viewport-height safe-area-all flex items-center justify-center bg-brand-mist">
      <div className="w-full max-w-md rounded-card border border-brand-ice bg-white p-6 text-center shadow-card">
        ...
        <Icon
          ...
          width={34}
          height={34}
          className="mx-auto mt-4 text-brand-steel"
        />
        ...
        <Link
          href="/"
          className="mt-5 flex min-h-11 items-center justify-center rounded bg-brand-blue px-4 font-heading text-sm font-semibold uppercase tracking-wide text-white"
        >
          Return Home
        </Link>
      </div>
