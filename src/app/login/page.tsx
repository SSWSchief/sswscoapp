      ...
      <div className="w-full max-w-sm rounded-card bg-white border border-brand-ice shadow-2xl p-8">
        ...
        <form className="space-y-4">
          ...
          <Link
            ...
            className="flex h-10 w-full items-center justify-center rounded bg-brand-blue font-heading text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-brand-navy"
          >
            Sign In
          </Link>
        </form>
