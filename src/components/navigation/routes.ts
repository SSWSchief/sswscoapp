...
export const staffNavSections: AppNavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "messages",
        permission: "messages",
        keywords: "chat announcements direct",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "truck",
        permission: "trucks",
        keywords: "fleet assets",
      },
      {
        href: "/dispatcher/dumpsters",
        label: "Dumpsters",
        icon: "dumpster",
        permission: "dumpsters",
        keywords: "containers assets",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "pto attendance requests",
      },
      {
        href: "/dispatcher/absence-calendar",
        label: "Absence",
        icon: "calendar",
        permission: "absence",
    ...
    items: [
      {
        ...
        keywords: "admin leadership oversight",
      },
      {
        ...
        icon: "settings",
        permission: "settings",
        keywords: "company roles sop pretrip",
      },
    ],
  },
];

export const staffNavItems = staffNavSections.flatMap(
...
export const driverPrimaryNav: AppNavItem[] = [
  {
    ...
    keywords: "home assigned work",
  },
  {
    href: "/driver/time-clock",
    label: "Time",
    icon: "clock",
    permission: "time_clock",
    keywords: "time clock",
