...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      reporter: ["text", "html"],
      include: [
        "src/lib/{client-api,client-download,csv,email-delivery,job-dates,job-transitions,logger,owners,password-policy,permissions,portal-access,time-clock,utils,validation}.ts",
