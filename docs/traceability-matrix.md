...
| Stripe invoicing           | Staff with permission  | invoices + `/api/invoices/*`     | RPC-only numbered drafts, immutable lines/jobs, signed webhook inbox, reconciliation | invoice/API/webhook pgTAP and staging E2E |
